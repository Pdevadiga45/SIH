...
def transcribe_audio(audio_path):
    ...
    audio, _ = librosa.load(audio_path, sr=16000)  # Whisper expects 16kHz audio
...
if __name__ == "__main__":
    ...
    audio_path = "C:\\Users\\HP\\Downloads\\hello_there.mp3"  # Update this path
    transcription = transcribe_audio(audio_path)
    print("Transcription:", transcription)
    
    # Step 2: Process the transcribed text into ISL
    process_text(transcription)
